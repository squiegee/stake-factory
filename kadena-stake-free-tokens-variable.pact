                        ...
                        (let
                            ...
                            (if (>= time-since-end-time 0.0 )
                              (let
                                  ...
                                  ;Deactivate pool due to exhaustion
                                  (update pools pool-id
                                    {
                                        "active": false
                                    }
                              ...
                              (let
                                  ...
                                  ;Transfer free.tokens stake token to pool
            ...
            (let
                  ...
                  (let
                      ...
                      (let
                          ...
                          ;Return message
                          (format "Rewarded {} with {} {} for {}% of pool and unstaked {} {}" [account to-pay reward-token  (floor (* (/ (at "balance" stake) (at "tokens-locked" pool-usage-data)  ) 100) 2) to-pay-stake (get-pair-key (at "lp-token1" pool-lp-stats) (at "lp-token2" pool-lp-stats))])
